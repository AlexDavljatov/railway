 ...
 */
public class MyClientImple implements Runnable {
    ...
    MyClientImple(String s) {
        this.s = s;
    }

    /**
     * MyClientImple(AsynchronousServerSocketChannel server) {
     * try {
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 5; i++)
            new Thread(new MyClientImple(String.valueOf(i))).start();
    }
